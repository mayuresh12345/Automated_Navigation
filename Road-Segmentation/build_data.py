...
def save_inference_samples(data_dir, image_shape, model_path):
    output_dir = os.path.join(str(time.time()))
    ...
    image_outputs = gen_test_output(model, os.path.join(data_dir, 'dataset/testing'), image_shape)
